...
class Militar(models.Model):
    ...
    identidade  = models.CharField(max_length=25, null=True, blank=True, help_text="Identidade Militar")
    ...
    conta_tipo = models.CharField(max_length=50, choices=[("corrente","Corrente"), ("poupança","Poupança"), ("salario","Salario"), ("investimento","Investimento")], default="corrente")
    aptidao  = models.CharField(max_length=250, blank=True, null=True, help_text='Se o militar tem alguma aptidão, ou função')

    subunidade  = models.ForeignKey(SubUnidade, on_delete=models.SET_NULL, blank=True, null=True)
    pelotao     = models.ForeignKey(Pelotao, on_delete=models.SET_NULL, blank=True, null=True)
    grupo_combate     = models.ForeignKey(GrupoCombate, on_delete=models.SET_NULL, blank=True, null=True)
    funcao      = models.CharField(max_length=250, blank=True, null=True, help_text='Cmt Cia, Cmt Pel, Adj Pel, Cmt GC, Cmt Esq, E1, A1?')
