...
class Militar(models.Model):
    ...
    identidade  = models.CharField(max_length=25, null=True, blank=True, unique=True, verbose_name="Identidade Militar")
    ...
    cnh         = models.CharField(max_length=25, null=True, blank=True, unique=True, verbose_name="CNH")
    cnh_categoria = models.CharField(max_length=3, verbose_name="Categoria da CNH", choices=[("A","A"), ("B","B"), ("AB","AB"), ("C","C"), ("D","D"), ("E","E")], null=True, blank=True)
